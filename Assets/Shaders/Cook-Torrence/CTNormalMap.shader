    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 fragmentShader(v2f f) : SV_Target
            {
                ...
                float3 albedoBase;
                if (_AlbedoMode == 1)
                    albedoBase = tex2D(_MainTex, f.uv_MainTex).rgb;
                else
                    albedoBase = _BaseColor.rgb;

                float3 albedo = albedoBase * _MaterialKd.rgb;
                ...
                float3 ambient = _MaterialKa.rgb * _AmbientLight.rgb * albedoBase;
